...
export XCODEGEN_ZUO_CODE_SIGN_IDENTITY="zuo-codesign-certificate"
...
while test $# -gt 0; do
    case $1 in
        ...
        --codesign-identity) XCODEGEN_ZUO_CODE_SIGN_IDENTITY="$2"; shift 2 ;;
...
public let zuoAppVersion = "$build_version"
EOF
...
if test $generate_xcodeproj = 1; then
    export XCODEGEN_ZUO_VERSION=$build_version
