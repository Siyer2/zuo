...
// tag::purpose[]
:manpurpose: Subscribe to Zuo events and receive notifications via socket
// end::purpose[]
...
This command connects to the Zuo server and receives real-time event notifications as JSON lines.
