...
*Guide:* https://nikitabobko.github.io/Zuo/guide +
...
You can find the full text of Zuo license and its dependencies in the 'legal' directory of the distributed zip archive.
