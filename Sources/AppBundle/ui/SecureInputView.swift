    ...
    var body: some View {
        ZStack(alignment: .center) {
            ...
            if isMinimized {
                ...
                Text("Zuo cannot respond to keyboard shortcuts while **Secure Input** is active. **Secure Input** is a macOS security feature that prevents applications from reading keyboard events.")
                    .font(.title3)
                    .padding(10)
            }
        }
