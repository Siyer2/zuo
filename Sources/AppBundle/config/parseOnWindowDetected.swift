...
struct WindowDetectedCallbackMatcher: ConvenienceCopyable, Equatable {
    ...
    var debugJson: Json {
        ...
        if let duringZuoStartup {
            resultParts.append("duringZuoStartup=\(duringZuoStartup)")
        }
...
private let matcherParsers: [String: any ParserProtocol<WindowDetectedCallbackMatcher>] = [
    ...
    "during-zuo-startup": Parser(\.duringZuoStartup, upcast(parseBool)),
]
